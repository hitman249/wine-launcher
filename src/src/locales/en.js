...
`,
  ...
  prefix:      {
    ...
    'form-config':       {
      ...
      'forbidden-gamepads':      'Disable gamepads',
      'forbidden-gamepads-desc': 'Disables handling gamepads via WL',
      ...
      'game-png-desc':           'In PNG format',
      'game-png-icon-desc':      'In PNG or ICO format',
    ...
    'form-prefix':       {
      ...
      'vkd3d-proton-desc':        'Speeding up dx12 games through Vulkan',
      'update-vkd3d-proton-desc': 'Auto update VKD3D Proton',
