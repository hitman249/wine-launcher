...
`,
  ...
  prefix:      {
    ...
    'form-config':       {
      ...
      'fsr-desc':                'AMD FidelityFX Super Resolution (FSR) - технология увеличения масштаба для повышения частоты кадров',
      ...
      'forbidden-gamepads':      'Отключить геймпады',
      'forbidden-gamepads-desc': 'Отключает обработку геймпадов через WL',
      ...
      'gl_override-desc':        'Принудительно переназначить версию OpenGL на {version}. Помогает запустить некоторые игры. Иногда исправляет ошибки драйвера.',
    },
    'form-prefix':       {
      ...
      'winemenubuilder':          'Отключить создание ярлыков и типов (внутри Wine)',
    },
  },
  forms:       {
